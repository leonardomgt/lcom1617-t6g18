...
#define ESC_SCANCODE	0x81 /**< @brief ESC scancode */
#define ENTER_SCANCODE	0x9C /**< @brief ENTER scancode */
#define SPACE_SCANCODE	0xB9 /**< @brief SPACE scancode */
#define ONE_SCANCODE	0x82 /**< @brief ONE scancode */
#define TWO_SCANCODE	0x83 /**< @brief TWO scancode */
#define THREE_SCANCODE	0x84 /**< @brief THREE scancode */
#define FOUR_SCANCODE	0x85 /**< @brief FOUR scancode */
